...
extern int usbd_multi_mcu_eeprom_write_FRU1(unsigned char usb_cnt, char* filename );
extern int usbd_multi_mcu_eeprom_read(unsigned char usb_cnt, unsigned char* out_buf);
extern int usbd_multi_mcu_eeprom_read_FRU1(unsigned char usb_cnt, unsigned char* out_buf);
